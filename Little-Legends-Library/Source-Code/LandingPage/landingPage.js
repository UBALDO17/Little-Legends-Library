    ...
    bookSelectionContainer.innerHTML = `
        <div class="book-item">
            ...
            <div class="format-options">
                ...
                <label for="digital">Digital (₱${product.price})</label>

                <input type="radio" id="physical" name="format" value="Physical">
                <label for="physical">Physical (₱${product.price * 2})</label>
            </div>
        </div>
    `;
...
function submitOrder() {
    ...
    let product = storedProduct ? JSON.parse(storedProduct) : { name: "Unknown Product", price: 0 };
    ...
    let price = format === "Physical" ? basePrice * 2 : basePrice;
